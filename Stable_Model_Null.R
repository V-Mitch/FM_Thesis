...
data_1_o <- read.csv("~/R tests/finance related projects/usdahe_m_m_dataframe.csv")
data_1 <- data_1_o[nrow(data_1_o):1,]

data_2_o <- read.csv("~/R tests/finance related projects/usdnfp_m_m_dataframe.csv")
