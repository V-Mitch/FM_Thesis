...
\begin{center}
\textbf{Abstract}: This study uses data from 2008 to 2019 to investigate the possibility that the macroeconomic news announcements are causing inconsistent price shocks to exchange rates. The evolution of these price shocks is thereafter estimated when it is presumed there is instability over time. Separate methodologies from past literature are applied to the data and compared to one another. In addition we juxtapose the the methods with our objective and evaluate their use.
\end{center}
