...
Alternitavely, two tests suggested by [@brown_techniques_1975] named the CUSUM and CUSUM-squared were run. The tests use the successive error terms of predictions of an RLS model that assumes stability of the $\beta$ parameter. By examining the errors in prediction, one can observe whether or not they violate the $N(0,\sigma^2)$ assumptions 
  
  
\begin{equation} 
W_t = \frac{1}{\hat{\sigma_cs}\sum_{i=k+1}^{t} u_{n,i} 
\end{equation}
