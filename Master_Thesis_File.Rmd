...
Conveniently, there is a natural extension of the use of the qLL test elaborated in [Section 4.1] as it provides a means to obtain an efficient parameter path [@muller_efficient_2010]. 
