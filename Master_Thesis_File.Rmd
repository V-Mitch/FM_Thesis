...
On the contrary, the STVP estimation is susceptible to exceptional or isolated changes to the price-reaction to the macro-announcements at any time during the sample. The $\beta_t$ will drastically changes when both the surprise $S_t$ shock and the difference $R_t - S_t^T\beta_{t-1}$ are large in absolute terms. 
